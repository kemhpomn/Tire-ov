...
class DatasetStatisticsAnalyzer:
    ...
    def __init__(self, dataset_dir, output_dir='outputs/statistics'):
        ...
        self.image_paths = set()  # 使用 set 自动去重
        self.pixel_values = []
    ...
    def collect_images(self, image_extensions=None):
        ...
        for ext in image_extensions:
            # 使用 set.update 自动去重，避免大小写导致的重复
            self.image_paths.update(self.dataset_dir.rglob(f'*{ext}'))
            self.image_paths.update(self.dataset_dir.rglob(f'*{ext.upper()}'))
